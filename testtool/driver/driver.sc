...
**			- created
**	20-apr-94 (vijay)
**		Problem with aix compiler. need to compile this with no_optim.
**
**	contents:
**		signal_trap()
**		signal_setup()
...
**
**	29-Dec-1995 (somsa01)
**		Added #defines for SIGHUP and SIGQUIT for NT_GENERIC platforms.
**      17-Aug-1999 (hweho01)
**              Added <stdlib.h> header file, it provides the function  
**              prototype of malloc(). Without the function declaration, 
**              the default int(4 byte) return type will result in 64-bit
**              address being truncated on ris_u64 platform.
**	16-aug-2001 (toumi01)
**	    speculative i64_aix NO_OPTIM change for beta xlc_r - FIXME !!!
**	10-jun-2003 (abbjo03)
**	    Add forward declarations and includes to eliminated warnings on VMS.
**	21-Dec-2007 (drivi01)
**	    Certain sygnals do not exist on Windows, and Visual Studio 2005
**	    doesn't handle that as gracefully as Visual Studio 2003 did.
**	    Added code to avoid signal() call for signal numbers that do not exist.
*/
...
void dump_that_main_fella();
void end_clean();
void parse_args(int argci, char *argvi[]);
void print_all_tests();
void print_syntax();
void sched_all_tests();
